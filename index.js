...
bot.on("ready", async () => {
    ...
    bot.user.setActivity("SpookyCraft", {
        type: "PLAYING"
    });
...
bot.on("guildMemberAdd", member => {
    ...
    const channel = member.guild.channels.find("id", "697911186477285426");
    ...
    //FETCH MEMBER COUNT -> #member
        member.guild.fetchMembers().then(g => {
            ...
            var joinEmbed = new discord.RichEmbed()
                    .setAuthor("Welkom!", icon)
                    .setColor("#29e53f")
                    .setDescription(`Welkom op de server ${member}!`)
                    .setFooter(`jij bent nummer #${count} van SpookyCraft!`);
...
bot.on("message", async message => {
    ...
    //IDEEEN KANAAL
    if (message.channel.id == "698205503116804166") {
        ...
        var kickChannel = message.guild.channels.find("id", "698205503116804166");
